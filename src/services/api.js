...
export async function getStudentDashboard(studentId) {
  ...
  return {
    ...
    tasks: [
      ...
      {
        id: 4,
        title: byLanguage(lang, 'مشروع البرمجة الكينونية المبدئي', 'Initial OOP Project'),
        deadline: byLanguage(lang, 'بعد يومين', 'In 2 days'),
        progress: 25,
        urgency: 'danger',
        canSplit: false,
        aiNote: byLanguage(lang, 'تم إنجاز الهيكل الأساسي، ركز على الكلاسات اليوم.', 'Base structure is done, focus on classes today.'),
      },
      {
        id: 5,
        title: byLanguage(lang, 'تلخيص وحدة الذكاء الاصطناعي', 'AI Module Summary'),
        deadline: byLanguage(lang, 'نهاية الأسبوع', 'End of week'),
        progress: 80,
        urgency: 'success',
        canSplit: false,
        aiNote: byLanguage(lang, 'جهد مميز! اقتربت من إنهاء المهمة.', 'Great effort! Almost done.'),
      },
    ],
    splitSteps: [
